...
type AuthClient interface {
	...
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginReponce, error)
...
func (c *authClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginReponce, error) {
	out := new(LoginReponce)
...
type AuthServer interface {
	...
	Login(context.Context, *LoginRequest) (*LoginReponce, error)
...
func (UnimplementedAuthServer) Login(context.Context, *LoginRequest) (*LoginReponce, error) {
