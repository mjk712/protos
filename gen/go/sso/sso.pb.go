...
func (x *LoginReponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginReponce) ProtoMessage() {}

func (x *LoginReponce) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginReponce.ProtoReflect.Descriptor instead.
func (*LoginReponce) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{3}
}

func (x *LoginReponce) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x22, 0x24, 0x0a, 0x0c, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x63, 0x65,
	...
	0x1a, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x70,
	0x6f, 0x6e, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x07, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12,
	...
	0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x42, 0x13, 0x5a, 0x11,
	0x67, 0x72, 0x65, 0x67, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*LoginReponce)(nil),     // 3: auth.loginReponce
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	3, // 4: auth.Auth.Login:output_type -> auth.loginReponce
